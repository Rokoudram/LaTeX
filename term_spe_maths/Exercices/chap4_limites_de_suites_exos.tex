...
On définit la suite $(u_n)_{\nN}$ par $\begin{cases}u_0=1\\u_{n+1}=\frac{u_n}{1+u_n}\end{cases}$
\begin{enumerate}
    \item Démontrer par récurrence que $1\geq u_n>0$
    \item Déterminer le sens de variation de $(u_n)_{\nN}$
    \item En déduire que la suite $(u_n)_{\nN}$ converge
...
On définit la suite $(u_n)_{\nN}$ par $\begin{cases}u_0=1\\u_{n+1}=\frac{1}{2}u_n-3\end{cases}$
\begin{enumerate}
...
On considère une suite $(u_n)_{\nN}$ telle que $\begin{cases}u_0=\frac{1}{2}\\u_{n+1}=\frac{2}{3-u_n}\end{cases}$
\begin{enumerate}
    \item Montrer que $u_n\in[0;1]$ pour tout $\nN$
    \item Démontrer que la suite $(u_n)_{\nN}$ est croissante.
...
On considère une suite $(u_n)_{\nN}$ définie par $\begin{cases}u_0=1\\u_{n+1}=\frac{1}{2}u_n+3n+1\end{cases}$
\begin{enumerate}
...
On définit la suite $(u_n)_{n\geq1}$ par $\begin{cases}u_1=\sqrt{2}\\u_{n+1}=\sqrt{\frac{n+2}{n}}\times u_n\end{cases}$
\begin{enumerate}
...
On considère la suite $(u_n)_{\nN}$ définie par $\begin{cases}u_0=2\\u_{n+1}=3u_n-5\end{cases}$
\begin{enumerate}
    \item Calculer les 5 premiers termes de $(u_n)_{\nN}$
    \item Montrer que $(u_n)_{\nN}$ n'est ni arithmétique ni géométrique
...
On définit deux suite $(u_n)_{\nN}$ et $(v_n)_{\nN}$ par $\begin{cases}u_0=2\\u_{n+1}=\frac{2u_n+3v_n}{5}\end{cases}$ et $\begin{cases}v_0=3\\v_{n+1}=\frac{3u_n+2v_n}{5}\end{cases}$\\
...
On définit la suite $(u_n)_{n \in \mathbb{N}}$ par : $\begin{cases}u_0=1\\u_{n+1}=2\left(u_n+{u_n}^2\right)\end{cases}$
\begin{enumerate}
...
On définit deux suites $(u_n)_{\nN}$ et $(v_n)_{\nN}$ par : $\begin{cases}u_0=2\\u_{n+1}=\frac{u_n+v_n}{2}\end{cases}$ et $\begin{cases}v_0=1\\v_{n+1}=\frac{u_n-v_n}{2}\end{cases}$
\begin{enumerate}
    \item Montrer que pour tout $\nN,\quad u_{n+2}=\frac{u_n}{2}$ et $v_{n+2}=\frac{v_n}{2}$
    \item Montrer par récurrence que $u_n\geq v_n\geq0$
    \item Montrer que $(u_n)_{\nN}$ est décroissante et en déduire que $(u_n)_{\nN}$ converge vers une limite notée $\ell$
...
On définit la suite $(u_n)_{\nN}$ par $\begin{cases}u_0=\frac{1}{2}\\u_{n+1}=f(u_n)\end{cases}$
\begin{enumerate}
    \item Calculer les 5 premiers termes de la suite $(u_n)_{\nN}$.\\
    ...
    \item Étudier les variations de la suite $(u_n)_{\nN}$
    \item Montrer que $(u_n)_{\nN}$ converge.
...
\begin{enumerate}
    ...
    \item On considère la suite $(u_n) : \begin{cases}u_0=\frac{1}{5}\\u_{n+1}=g(u_n)\end{cases}$
    \begin{enumerate}
...
On considère la suite $(u_n)_{\nN}$ définie par $\begin{cases}u_0=2\\u_{n+1}=\frac{1+2u_n}{2+u_n}\end{cases}$ 
\begin{enumerate}
    \item Montrer par récurrence que $1<u_n\leq2$ à l'aide d'une fonction correctement choisie.
    \item Déterminer le sens de variation de $(u_n)_{\nN}$, et en déduire que la suite converge.
...
\begin{enumerate}
    ...
    \item On définit la suite $(u_n)_{n \in \mathbb{N}}$ par $\begin{cases}u_0=1\\u_{n+1}=\ln(1+u_n)\end{cases}$
    \begin{enumerate}
...
\textit{On dit qu'une suite $(u_n)_{\nN}$ est périodique de période $p$ si pour tout $\nN$ on a : $u_{n+p}=u_n$ \\
L'exemple le plus connu de suite périodique est $u_n=(-1)^n$ dont la période est 2}
\begin{enumerate}
    \item Soit $(u_n)_{\nN}$ définie par $\begin{cases}u_0=a\in\RR\\u_{n+1}=5-u_n\end{cases}$\\
    Montrer que $(u_n)$ est périodique.
    \item On considère la suite $(v_n)_{\nN}$ définie par $\begin{cases}v_0=2\\v_{n+1}=\frac{v_n-2}{2v_n-1}\end{cases}$\\
...
Soit $(u_n)_{\nN}$ une suite géométrique pour laquelle $u_0$, $u_1$ et $u_3$ sont trois termes consécutifs d'une suite arithmétique.\\
