...
\begin{tabular}{p{0.3\textwidth} p{0.3\textwidth} p{0.3\textwidth}}
    ...
    a) $\begin{cases}u_{0} = 2\\u_{n+1}=\frac{4+u_{n}}{2}\end{cases} $
    &
    b) $\begin{cases}u_{1} = 1\\u_{n+1}=u_n+\frac{1}{n}\end{cases} $
    &
    c) $\begin{cases}u_{0} = 1\\u_{n+1}=n\times u_n\end{cases} $ \\

    d) $\begin{cases}u_{0} = \frac{1}{4}\\u_{n+1}=-2u_n\end{cases} $
    &
    e) $\begin{cases}u_{0} = -1\\u_{n+1}=\frac{\sqrt{2+u_n}}{u_n}\end{cases} $
    &
    f) $\begin{cases}u_{1}=1\\u_{n+1}=\frac{1+u_{n}}{u_{n}}\end{cases}$ 
\end{tabular}
...
On considère la suite $(u_n)_{\nN}$ définie explicitement par $u_n=n^3-3n^2-5n$
\begin{enumerate}
...
\begin{tabular}{p{0.3\textwidth} p{0.3\textwidth} p{0.3\textwidth}}
    ...
    j) $\begin{cases}u_{0}=1\\u_{n+1}=u_n^{2}-2u_n+3\end{cases} $ & k) $\begin{cases}u_{0}=2\\u_{n+1}=\frac{1+u_n^{3}}{u_n^{2}}\end{cases}$ & l) $\begin{cases}u_{1}=5\\u_{n+1}=10-u_n\end{cases} $
\end{tabular}
...
\begin{tabular}{p{0.3\textwidth} p{0.3\textwidth} p{0.3\textwidth}}
    ...
    d) $ \begin{cases}u_{1}=3\\u_{n+1}=-u_n+2\end{cases}$ & e) $\begin{cases}u_{0}=-1\\u_{n+1}=u_n-5\end{cases}$ & f) $\begin{cases}u_{0}=2\\u_{n+1}=\frac{3u_n-2}{u_n}\end{cases}$ 
\end{tabular}
...
\begin{enumerate}
    \item Soit $(u_n)_{\nN}$ une suite arithmétique de raison 4 et telle que $u_{13}=63$. Combien vaut $u_{5}$ ? 
    \item $(u_n)_{\nN}$ est une suite arithmétique telle que $u_{7}=20$ et $u_{11}=14$. Donner la raison et le premier terme de $(u_n)$
	\item Soit $(u_n)_{\nN}$ une suite arithmétique pour laquelle $u_3=10u_0$. Montrer alors que $u_5=4u_1$
\end{enumerate}
...
On considère la suite $(u_n)$ définie par $\begin{cases}u_{0}=1\\u_{n+1}=\frac{2u_n}{2+3u_n}\end{cases}$
...
On définit la suite $(u_n)_{\nN}$ par $\begin{cases}u_0=0\\u_{n+1}=\frac{3-2u_n}{4-3u_n}\end{cases}$
\begin{enumerate}
...
\begin{tabular}{p{0.3\textwidth} p{0.3\textwidth} p{0.3\textwidth}}
	...
	d) $ \begin{cases}u_{1}=2\\u_{n+1}=n\times u_n\end{cases}$ & e) $\begin{cases}u_{0}=10\\u_{n+1}=\frac{u_n}{5}\end{cases}$ & f) $u_n=3n^{2}$
\end{tabular}
...
On considère une suite géométrique $(u_n)_{\nN}$ pour laquelle l'égalité $u_{n+2}=\frac{5u_{n+1}+3u_n}{2}$ est toujours vérifiée.
...
On définit la suite $(u_n)$ par $\begin{cases}u_{0}=2\\u_{n+1}=3u_n+4\end{cases}$
\begin{enumerate}
    \item Calculer les 4 premiers termes de $(u_n)$
...
On définit la suite $(u_n)$ par $\begin{cases}u_0=0\\2u_n+n\end{cases}$
...
On considère la suite $(u_n)_{\nN}:\begin{cases}u_0=2\\u_{n+1}=4-\frac{3}{u_n}\end{cases}$
\begin{enumerate}
	\item Calculer les 4 premiers termes de la suite $(u_n)$
