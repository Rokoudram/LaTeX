...
Soit un parallélogramme $ABCD$. On considère les points $E$, $F$ et $G$ tels que $\vv{CE}=\vv{BD}$, $\vv{AF}+\vv{CD}=\vv{AC}$ et $3\vv{BG}=2\vv{DF}$
\begin{enumerate}
    \item Construire les points $A$, $B$, $C$, $D$, $E$, $F$ et $G$
    \item On se place dans le repère $(A;\vv{AB};\vv{AD})$
    \begin{enumerate}
        \item Donner les coordonnées des points $A$, $B$, $C$, $D$, $E$, $F$ et $G$
        \item Montrer que les points $E$, $F$ et $G$ sont alignés.
    \end{enumerate}
    \item On se place dans le repère $(F;\vv{FD};\vv{FE})$
    \begin{enumerate}
        \item Donner les coordonnées des points $A$, $B$, $C$, $D$, $E$, $F$ et $G$
...
On considère les points $M$, $N$ et $P$ tels que $\vv{AM}+\vv{BM}=2\vv{AC}$ , $2\vv{BN}=\vv{AC}$ et $\vv{PN}+\vv{PM}=\vv{AB}+\vv{AC}$
\begin{enumerate}
...
\begin{enumerate}
    \item On rapporte le plan au repère $(A;\vv{AB};\vv{AE})$
    \begin{enumerate}
        \item Donner les coordonnées des points $A$, $B$, $E$ et $D$
        \item Justifier que $\vv{AF}=\frac{1}{2}\vv{AD}+\vv{BA}$
        \item En déduire les coordonnées du point $F$ puis celles du point $B$
    \end{enumerate}
    \item On rapporte le plan au repère $(C;\vv{CF};\vv{AC})$
    \begin{enumerate}
        \item Donner les coordonnées des points $C$, $A$, $F$ et $D$
        \item Justifier que $\vv{CB}=\frac{1}{2}\vv{CF}+\vv{DC}$ et en déduire les coordonnées du point $B$
        \item Justifier que $\vv{CE}=\vv{CB}+2\vv{AF}$ et en déduire les coordonnées du point $E$
    \end{enumerate}
    \item On rapporte le plan au repère $(E;\vv{CA};\vv{BD})$
    \begin{enumerate}
        \item Donner les coordonnées des points $E$, $A$ et $C$
        \item Montrer que $\vv{EA}+\vv{CA}=3\vv{EF}$ et en déduire les coordonnées du point $F$
...
Soient $A$, $B$ et $C$ trois points du plan non alignés.\\
On considère les points $P$, $Q$ et $R$ tels que $2\vv{AP}+\vv{BP}=\vv{CA}$ , \quad $\vv{PQ}+3\vv{QB}=2\vv{AC}$ et $3\vv{CR}+\vv{AQ}=\vv{AR}$\\
On se place dans le répère $(A;\vv{AB};\vv{AC})$
\begin{enumerate}
