...
\section{Q.C.M.}
Cet exercice est un questionnaire à choix multiples. Pour chacune des questions suivantes, une et une seule des réponses proposées est exacte. Pour répondre, entourez sur la feuille la réponse choisie. \\
Une réponse correcte rapporte des points selon le barème du devoir. L'absence de réponse ne rapporte ni ne retire aucun point. Une réponse incorrecte ou une réponse multiple retire des points selon le barème du devoir. Aucune justification n'est demandée.
