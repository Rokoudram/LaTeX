...
\begin{tabular}{|p{0.6\textwidth}|p{1.5cm}|p{1.5cm}|} \hline
    ...
    \centering Si $\begin{cases}x+y\equiv 0 [22] \\ x-y\equiv 0 [22]\end{cases}$ alors $\begin{cases}x\equiv0[22] \\ y\equiv0 [22]\end{cases}$ & & \\ \hline
...
On définit la suite $(u_n)_{\nN}$ par $\begin{cases}u_0=7\\3u_n-5\end{cases}$
\begin{enumerate}
...
\begin{tabular}{p{0.3\linewidth} p{0.3\linewidth} p{0.3\linewidth}}
    a) $\begin{cases}2x+3y=126\\ \mathrm{PGCD}(x;y)=7\end{cases}$ & 
    b) $\begin{cases}x^2-xy=288\\ \mathrm{PGCD}(x;y)=12\end{cases}$ & 
    c) $\begin{cases}4x^2-y^2=972\\\mathrm{PGCD}(x;y)=18\end{cases}$
\end{tabular}
...
\begin{enumerate}
    ...
    On procède par l'absurde en supposant qu'il existe $n$, $m$ et $p$ tels que $u_n=1$, $u_m=\sqrt{2}$ et $u_p=2$ avec $(u_n)_{\nN}$ une suite arithmétique de raison $r$
    \begin{enumerate}
...
\begin{enumerate}
    ...
    \item Montrer que si $(u_n)_{\nN}derbrace{111\ldots111}_{n \text{ fois}}$ est un nombre premier, alors $n$ est également premier
\end{enumerate}
