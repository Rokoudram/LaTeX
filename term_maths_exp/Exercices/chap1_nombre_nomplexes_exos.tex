...
\begin{enumerate}
    ...
    \begin{tabular}{p{0.33\textwidth} p{0.33\textwidth} p{0.33\textwidth}}
        $\begin{cases}z+w=2\\z\times w=3\end{cases}$ & $\begin{cases}z(w+1)=3\\w(z+1)=2\end{cases}$ & $\begin{cases}z^2+2w\,^2=1\\2z+w=3\end{cases}$ 
    \end{tabular}
\end{enumerate}
...
On définit la suite $(z_n)_{\nN}$ par $\begin{cases}z_0=i\\z_{n+1}=(1-i)z_n+2\end{cases}$
\begin{enumerate}
